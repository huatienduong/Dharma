...
export default function Dashboard() {
  ...
  return (
    ...
    >
      ...
      {/* ---------- Chân trang: nhà phát triển + liên hệ Facebook ---------- */}
      <footer className="mt-14 border-t border-border/60 pt-5">
        <div className="flex flex-col items-center gap-3 text-center">
          <p className="text-xs text-muted-foreground">
            {t("developer")}:{" "}
            <span className="font-semibold text-foreground/85">Hứa Tiến Dương</span>
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="inline-flex items-center gap-2 rounded-full border border-border/70 bg-card/70 px-3.5 py-1.5 text-xs font-medium text-foreground/85 transition hover:border-primary/40 hover:bg-accent"
