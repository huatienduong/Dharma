...
const VI = {
  ...
  navSuttas: "Kinh tạng",
  navVinaya: "Luật tạng",
  navAbhidhamma: "Luận tạng",
  navDictionary: "Từ điển",
  navCalendar: "Lịch Phật giáo",
  navMeditation: "Thiền",
  navAssistant: "Trợ lý Phật học",
  navSettings: "Cài đặt",
  navLookup: "Tra cứu Wikipedia",
  navNews: "Tin tức",
  navBuddhistHistory: "Lịch sử Phật giáo",
  navWatched: "Lịch sử xem",
  navProfile: "Hồ sơ",
  logout: "Đăng xuất",
  openMenu: "Mở menu",
  closeMenu: "Đóng menu",
