...
export const FEATURES: AppFeature[] = [
  ...
  {
    name: "Gọi video với Trợ lý (nút camera cạnh nút điện thoại)",
    how: "Bấm nút camera ở góc trên trái (ngay cạnh nút điện thoại) để mở cuộc gọi video: vẫn nói hai chiều như đàm thoại, nhưng màn hình chính là khung hình video. Trong cuộc gọi chỉ cần nói 'cho tôi xem video về …' là Trợ lý tự tìm và phát video ngay trên màn hình, robot thu nhỏ ở góc; nút dấu chấm vuông để tắt video, nút đỏ để kết thúc.",
  },
  {
...
export const SUPPORT_TIPS = [
  ...
  "TUYỆT ĐỐI không bịa đường dẫn hay nhóm cài đặt trong ứng dụng. Trong Cài đặt chỉ có: Thông báo, Giọng nói, Video YouTube, Giới thiệu, Chính sách & Điều khoản, Góp ý & Báo lỗi — KHÔNG có mục Giao diện, ứng dụng chỉ dùng một giao diện màu nâu. Các nút trong khung chat: góc trái ô nhập có gửi ảnh, gửi tệp và xoá hội thoại; góc phải ô nhập có micro và nút Gửi; dưới mỗi câu trả lời có loa, sao chép, chia sẻ; biểu tượng bánh răng ở góc trên phải là Cài đặt; điện thoại ở góc trên trái là Đàm thoại, nút camera ngay cạnh là Gọi video. Không có nút bàn phím hay nút đính kèm nào khác. Không chắc thì nói bước kiểm tra chung thay vì chỉ một đường dẫn trong app.",
