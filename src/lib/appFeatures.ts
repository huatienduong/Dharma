...
export const FEATURES: AppFeature[] = [
  ...
  },
  {
    ...
    how: "Người dùng chỉ cần hỏi hoặc dán link YouTube — không cần bấm nút nào. Trợ lý trả lời trước, sau đó ứng dụng tự tìm video và hiện thẻ xem ngay dưới câu trả lời; bấm nút play là xem tại chỗ, không cần mở app khác. Muốn tìm video theo chủ đề thì dán khoá YouTube Data API vào Cài đặt → Video YouTube; dán link YouTube thì xem được ngay, không cần khoá.",
  },
  {
