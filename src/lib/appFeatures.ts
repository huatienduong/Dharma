...
export const FEATURES: AppFeature[] = [
  ...
  },
  {
    ...
    how: "Có hai cách. (1) Ô TÌM VIDEO ngay trong khung chat: bấm nút ▶ (cạnh nút gửi ảnh, bên trái ô nhập) để mở ô tìm, gõ chủ đề rồi bấm 'Tìm' — kết quả video YouTube hiện ngay dưới câu đó, bấm video nào là xem tại chỗ, không cần mở ứng dụng khác. (2) Chỉ cần hỏi hoặc dán link YouTube: Trợ lý trả lời trước, ứng dụng tự tìm video và gắn thẻ xem ngay dưới câu trả lời. Muốn tìm theo chủ đề chính xác hơn thì dán khoá YouTube Data API vào Cài đặt → Video YouTube; dán link YouTube thì xem được ngay, không cần khoá.",
  },
  {
...
export const SUPPORT_TIPS = [
  "XEM VIDEO — KHI NGƯỜI DÙNG HỎI VỀ VIDEO, HÃY TỰ HIỂU VÀ ĐỀ XUẤT NGAY. Đây là nguyên tắc bắt buộc: nếu câu hỏi có ý định xem video (chứa từ 'video', 'xem video', 'clip', 'youtube', 'bài giảng', 'bài hát', 'nghe thử', 'diễn giải video'...) hoặc người dùng dán link YouTube thì PHẢI: (1) trả lời câu hỏi ngay, đúng trọng tâm, không hỏi lại có muốn xem video không; (2) kết thúc bằng một câu mời xem ngắn gọn kiểu 'Mình để video ngay dưới câu này, bạn bấm nút play là xem'; (3) tuyệt đối KHÔNG nói kiểu 'mình không xem được video', 'mình không mở được YouTube', không đòi người dùng tự tìm video, không bịa đường dẫn hay tên kênh YouTube — ứng dụng tự lo phần tìm và hiện thẻ video ngay dưới câu trả lời của bạn. Nếu người dùng chỉ hỏi chủ đề mà bạn thấy họ vốn muốn xem video (ví dụ 'cho mình nghe về tánh niệm') thì cứ trả lời và mời xem video luôn, đừng dè dặt. Ngoài ra ứng dụng có SẴN Ô TÌM VIDEO ngay trong khung chat: bấm nút ▶ cạnh nút gửi ảnh ở góc trái ô nhập là mở ô tìm, gõ chủ đề rồi bấm 'Tìm' — kết quả video YouTube hiện ngay dưới câu đó và xem được tại chỗ. Khi người dùng hỏi về video hoặc bảo tìm/xem video, hãy chủ động nhắc họ dùng ô tìm video này (kèm cách bấm cụ thể), thay vì bảo họ tự lên YouTube tìm. Với người dùng lần đầu, nhắc thêm: muốn tìm theo chủ đề chính xác thì dán khoá YouTube Data API ở Cài đặt → Video YouTube.",
  "TUYỆT ĐỐI không bịa đường dẫn hay nhóm cài đặt trong ứng dụng. Trong Cài đặt chỉ có: Thông báo, Giọng nói, Video YouTube, Giới thiệu, Chính sách & Điều khoản, Góp ý & Báo lỗi — KHÔNG có mục Giao diện, ứng dụng chỉ dùng một giao diện màu nâu. Các nút trong khung chat: góc trái ô nhập có gửi ảnh, gửi tệp, tìm video (nút ▶) và xoá hội thoại; góc phải ô nhập có micro và nút Gửi; dưới mỗi câu trả lời có loa, sao chép, chia sẻ; biểu tượng bánh răng ở góc trên phải là Cài đặt; điện thoại ở góc trên trái là Đàm thoại. Không có nút bàn phím hay nút đính kèm nào khác. Không chắc thì nói bước kiểm tra chung thay vì chỉ một đường dẫn trong app.",
