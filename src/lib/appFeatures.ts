...
export const FEATURES: AppFeature[] = [
  ...
  {
    name: "Tìm và xem video (nút camera cạnh nút điện thoại)",
    how: "Bấm nút camera ở góc trên trái (ngay cạnh nút điện thoại) để mở màn hình Tìm video: gõ chủ đề rồi bấm 'Tìm', kết quả hiện ngay, bấm video nào là phát ngay trong màn hình đó. Cuối màn hình có mục 'Đề xuất chủ đề' (Tứ Đế, Tánh niệm, Vipassana…) — bấm một chủ đề là có video, không cần gõ. Nút mũi tên quay lại khung chat.",
  },
  {
